        ...
        <header class="navbar navbar-expand-md d-print-none">
            <div class="container-xl">
                ...
                <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('static/logo.svg') }}" width="110" height="32" alt="Garasale"
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown"
                            ...
                            <span class="avatar avatar-sm shadow-none"
                                style="background-image: url({{ Auth::user()->photo ? asset('assets/img/illustrations/profiles/profile-1.png') : asset('assets/img/illustrations/profiles/admin.jpg') }})">
                            </span>
